...
export const ORDER_FEE_TOOLTIP_MESSAGE = {
  '1': [
    '카멜 회원님의 빠르고 안전한 구매대행을 위한 결제대행 금융비용, 거래배상보험료, 프리미엄 배송료, 거래대행 물류비 (직거래/택배거래) 등이 포함되어 있습니다.\n\n카멜은 회원님의 편리하고 안전한 거래를 위해 최선을 다하겠습니다.'
  ],
  '2': [
    '업계 최저 검수비용이며, 정품감정보증서가 동봉됩니다. 검수 불가 및 가품 판정 시에는 검수비용 포함 모든 비용이 환불됩니다.'
  ],
  // '0': ['카멜이 사용하는 결제대행금융사인 PG사에 지불되는 비용입니다. (토스페이먼츠 등)'],
  '0': ['사기 걱정 없는 안전결제 수수료는 상품금액의 3%예요.']
};
