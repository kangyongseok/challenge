...
export const AUTH_PATH_NAMES = [
  '/camelSeller/guide',
  '/camelSeller/registerConfirm',
  '/camelSeller/registerConfirm/[id]',
  '/camelSeller/registerConfirm/selectBrand',
  '/camelSeller/registerConfirm/selectCategory',
  '/legit/profile/[id]/edit',
  '/legit/request/selectCategory',
  '/legit/request/selectBrand',
  '/legit/request/selectModel',
  '/legit/request/form',
  '/legit/request/edit',
  '/legit/admin',
  '/legit/admin/request/[id]',
  '/legit/intro',
  '/user/reviews/form',
  '/user/shop',
  '/user/shop/edit',
  ...
  '/mypage/settings/channelFixMessage',
