    ...
    <Flexbox direction="vertical" customStyle={{ height: '100%' }}>
      ...
      <SlideupFrame justifyContent="center" isAnimation={isAnimation}>
        <Image
          width={152}
          height="auto"
          src={`https://${process.env.IMAGE_DOMAIN}/assets/images/myportfolio/frame_left_img09.png`}
        ...
        <Image
          width={162}
          height="auto"
          src={`https://${process.env.IMAGE_DOMAIN}/assets/images/myportfolio/frame_right_img09.png`}
...
export default MyPortfolioLanding09;
