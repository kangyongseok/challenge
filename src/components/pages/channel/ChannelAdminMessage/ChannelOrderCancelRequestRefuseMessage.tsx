...
interface ChannelOrderCancelRequestRefuseMessageProps {
...
function ChannelOrderCancelRequestRefuseMessage({
  message: { createdAt },
  order,
  isSeller,
  onClickOrderDetail
}: ChannelOrderCancelRequestRefuseMessageProps) {
  const {
    palette: { common }
  } = useTheme();
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {isSeller ? '구매자의 요청을 거절했어요.' : '판매자가 요청을 거절했어요.'}
        </Typography>
...
export default ChannelOrderCancelRequestRefuseMessage;
